    ...
    return (
        ...
        >
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-6 relative z-10 w-full flex items-start lg:items-center justify-center pt-0 md:pt-0 lg:pt-0 pb-0 md:pb-0 lg:pb-0 lg:h-full">
                ...
                >
                    {/* Left Column: Image */}
                    <div className="relative order-1 lg:order-1 flex justify-center lg:justify-start z-10 w-full lg:w-1/2 xl:w-1/2 2xl:w-auto mb-4 md:mb-6 lg:mb-0 lg:mr-0 xl:mr-0 2xl:mr-[-55px]">
                        <ZoomIn className="relative w-full max-w-[300px] sm:max-w-[400px] md:max-w-[500px] lg:max-w-[640px] xl:max-w-[840px] 2xl:max-w-[991px] aspect-[991/782] flex-shrink-0">
                    ...
                    <div className="order-2 lg:order-2 text-white w-full lg:w-1/2 xl:w-1/2 2xl:w-auto text-center lg:text-left z-20">
                        ...
                        {displayData.stats && displayData.stats.length > 0 && (
                            <StaggerContainer className="grid grid-cols-1 sm:grid-cols-3 gap-6 lg:gap-8 mb-6 md:mb-8 lg:mb-12  pt-4 md:pt-6 lg:pt-8 w-full" delay={0.4}>
                        ...
                        <motion.a
                            ...
                            className="inline-flex items-center gap-[10px] transition-all hover:scale-105 w-auto justify-center text-sm md:text-base h-[48px] md:h-[56px] px-5 md:px-[30px] py-[7px] rounded-[12px] border border-white bg-[linear-gradient(73deg,#1D8FCF_32.85%,#2EABE2_82.8%)] text-white font-semibold mt-[10px] mx-auto lg:mx-0"
                            style={{
                                display: 'inline-flex',
                                alignItems: 'center',
                                gap: '10px',
