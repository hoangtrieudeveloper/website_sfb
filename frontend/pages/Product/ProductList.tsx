        ...
        <>
            ...
            >
                ...
                <div className="w-full flex-1 flex flex-col">
                    ...
                    {localizedName && (
                        <h3 className="self-stretch mb-3 min-h-[56px] lg:min-h-[auto] line-clamp-2 text-[var(--Color-2,#0F172A)] [font-feature-settings:'liga'_off,'clig'_off] font-['Plus_Jakarta_Sans'] text-lg lg:text-[20px] font-semibold lg:font-[600] leading-[28px] lg:leading-[30px]">
