...
export function AboutVisionMission({ data }: AboutVisionMissionProps) {
    ...
    const headerTitleRaw = displayData.headerTitle || visionMissionSectionData.header.title;
    const headerDescriptionRaw = displayData.headerDescription || visionMissionSectionData.header.description;
