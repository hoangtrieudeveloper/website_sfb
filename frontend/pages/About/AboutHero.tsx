...
export function AboutHero() {
    return (
        <section className="relative w-full h-auto lg:h-[760px] flex justify-center items-center bg-[linear-gradient(73deg,#1D8FCF_32.85%,#2EABE2_82.8%)] overflow-hidden py-20 lg:py-0">
