                    ...
                    <StaggerContainer className="text-white lg:max-w-[45%]">
                        <FadeIn>
                            <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-6">
                                {solutionsHeroData.title.line1}
                                <span className="block mt-2">
                                    {solutionsHeroData.title.line2}
                                </span>
                            </h1>
                        </FadeIn>
                        ...
                        <FadeIn delay={0.2}>
                            <p className="text-base md:text-lg text-white/90 mb-10 leading-relaxed font-light">
                                {solutionsHeroData.description}
                            </p>
                        </FadeIn>

                        <FadeIn delay={0.4} className="flex flex-col sm:flex-row gap-4">
                            <a
                                href={solutionsHeroData.button.link}
                                className="inline-flex items-center justify-center gap-[12px] px-[30px] py-[7px] h-[56px] rounded-[12px] border border-white bg-[linear-gradient(73deg,#1D8FCF_32.85%,#2EABE2_82.8%)] text-white font-medium text-sm transition-transform hover:scale-105 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] shadow-md"
                            >
                                {solutionsHeroData.button.text}
                                <ArrowRight size={18} />
                            </a>
                            <a
                                href={solutionsHeroData.secondaryButton.link}
                                className="inline-flex items-center justify-center gap-[12px] px-[30px] py-[7px] h-[56px] rounded-[12px] border border-white/40 bg-white/10 backdrop-blur-sm text-white font-medium text-sm transition-transform hover:scale-105 hover:bg-white hover:text-[#0870B4]"
                            >
                                {solutionsHeroData.secondaryButton.text}
                            </a>
                        </FadeIn>
                    </StaggerContainer>
...
export default function SolutionsHeroPage() {
    return null;
}