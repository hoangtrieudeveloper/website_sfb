...
async function setupAll() {
  ...
  try {
    ...
    console.log('🔄 Step 4/6: Migrating products data to optimized tables...');
    ...
    try {
      ...
      console.log('🗑️  Step 4.5/6: Dropping deprecated tables...');
    ...
    console.log('📊 Step 5/6: Verifying tables...');
